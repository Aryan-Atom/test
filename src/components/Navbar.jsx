...
const PAGE_BREADCRUMBS = {
  ...
  "ai-jobs": { section: "nav.aiPipeline", title: "nav.aiJobs" },
  "ai-review": { section: "nav.aiPipeline", title: "nav.aiReview" },
  "ai-quarantine": { section: "nav.aiPipeline", title: "nav.aiQuarantine" },
